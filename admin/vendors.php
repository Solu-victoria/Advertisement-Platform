										...
										<table class="table table-hover table-checkable order-column full-width"
											...
											<thead>
												<tr>
													...
													<th class="center"> KYC Document </th>
												</tr>
											</thead>
											<tbody>
												<?php
												...
												<tr class="odd gradeX">
													...
													<td class="center"><a href="../<?php echo $row['file']; ?>"><img src="../<?php echo $row['file']; ?>" width="50px" /></a></td>
													<td class="center">
														<?php
														if(!$row['is_approved']){
														?>
													<a class="btn btn-tbl-edit btn-xs" href='verify_kyc.php?id=<?php echo $row['id']; ?>'>
