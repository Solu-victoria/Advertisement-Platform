          ...
          <div id="main" role="main">
            <div class="slider">
              <div class="flexslider innerslider">
                <ul class="slides">
                  <li data-thumb="product_images/<?php echo $fetch['img1']; ?>"> <img
                      src="product_images/<?php echo $fetch['img1']; ?>" alt="" /> </li>
                  <li data-thumb="product_images/<?php echo $fetch['img2']; ?>"> <img
                      src="product_images/<?php echo $fetch['img2']; ?>" alt="" /> </li>
                  <li data-thumb="product_images/<?php echo $fetch['img3']; ?>"> <img
                      src="product_images/<?php echo $fetch['img3']; ?>" alt="" /> </li>
                  <li data-thumb="product_images/<?php echo $fetch['img4']; ?>"> <img
                      src="product_images/<?php echo $fetch['img4']; ?>" alt="" /> </li>
                </ul>
              </div>
            </div>
          </div>
          ...
          ?>
            <form method="post">
              <div class="contactWrp">
                ...
                <div class="input-wrap">
                  <input type="text" name="lname" placeholder="Last ame:" class="form-control">
                ...
                <div class="contact-btn">
                  <button class="sub" type="submit" value="submit" name="submitted"> <i class="fa fa-paper-plane"
            ...
            <form method='post'>
              ...
              <div class="contact-btn">
                <button class="sub" type="submit" value="submit" name="submit"> <i class="fa fa-paper-plane"
...
if (isset($_POST['submitted'])) {
  $vendorId = mysqli_real_escape_string($link, $_POST['vendor_id']);
  $fname = mysqli_real_escape_string($link, $_POST['fname']);
  $lname = mysqli_real_escape_string($link, $_POST['lname']);
  $emailv = mysqli_real_escape_string($link, $_POST['email']);
  ...
  //To address and name
  $mail->addAddress($vEmail); //Recipient name is optional

  //Send HTML or Plain Text email
  $mail->isHTML(true);

  $mail->Subject = "New Message from Onyinye Ads";
  $mail->Body = "You have a new contact message:<br/>Name: {$fname} {$lname}<br/>Email: {$emailv}<br/>Message: {$message}";
  ...
  try {
    $mail->send();
    $_SESSION['successmessage'] = "Message Sent";
    echo "<script>window.open('detail-page.php?id=$idd&&vId=$vId','_self')</script>";
  } catch (Exception $e) {
    $_SESSION['errormessage'] = "Message not sent: " . $mail->ErrorInfo;
    echo "<script>window.open('detail-page.php?id=$idd&&vId=$vId','_self')</script>";
  }
}