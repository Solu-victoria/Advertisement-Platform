										...
										<table class="table table-hover table-checkable order-column full-width"
											...
											<tbody>
												...
												<tr class="odd gradeX">
													...
													<td class="center"><?php echo $row['meal']; ?></td>
													<td class="center"><?php echo $row['bed']; ?></td>
													<td class="center">N<?php echo $row['rent']; ?></td>
													<td class="center <?php if($row['status']=='Available'){ echo 'text-success'; }else { echo 'text-danger'; }?>"><?php echo $row['status']; ?></td>
													<td class="center">
														<a href="edit_room.php?id=<?php echo $row['id']; ?>" class="btn btn-tbl-edit btn-xs">
															<i class="fa fa-pencil"></i>
														</a>
														<a href="delete_room.php?id=<?php echo $row['id']; ?>" class="btn btn-tbl-delete btn-xs">
