								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtRoomNo" name="roomno">
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<select class="mdl-textfield__input" name="ac">
												<option class="mdl-menu__item" value="">AC/Non AC</option>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<select class="mdl-textfield__input" name="meal">
												<option class="mdl-menu__item" value="">Meal</option>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<select class="mdl-textfield__input" name="bed">
												<option class="mdl-menu__item" value="">Bed Capacity</option>
...
<?php
	if(isset($_POST['submit'])){
		...
		if($count!=0){
			...
			$insert=mysqli_query($link, "INSERT into rooms (room_no,type,ac,meal,bed,rent) values ('$roomno','$roomtype','$ac','$meal','$bed','$rent')")or die(mysqli_error($link));
